...
function About({}: Props) {
  return (
    <motion.div 
      ...
      className='flex flex-col relative h-screen text-center md:text-left md:flex-row max-w-7xl px-40 justify-evenly mx-auto items-center'>
        ...
        alt="profile pic"
        className="-mb-20 md:mb-0 flex-shrink-0 w-40 h-40 rounded-full object-cover md:rounded-lg md:w-64 md:h-95"
        />
