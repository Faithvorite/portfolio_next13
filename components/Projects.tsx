...
function Projects({}: Props) {
  ...
  return (
    <div className=' h-screen min-h-[500px] relative flex overflow-hidden flex-col text-left lg:flex-row max-w-full justify-evenly mx-auto items-center z-0 py-4 sm:py-10 bg-gradient-to-b from-[rgb(107,43,43)]/0 to-[rgb(107,43,43)]/10'>
        ...
        <div className='relative w-full h-11/12 lg:h-9/12 flex overflow-x-scroll overflow-y-hidden snap-x z-20 scrollbar scrollbar-track-white/60 scrollbar-thumb-[rgb(107,43,43)]/80 px-5 '>
            ...
            {projects.map((project, i)=> (
                <div key={i} className='lg:flex-row w-11/12 lg:w-9/12 flex-shrink-0 snap-center flex flex-col space-y-2 items-center justify-center mx-2 sm:mx-12 xl:mx-24 p-2 sm:p-4 mb-4 sm:mb-10 '>
                    ...
                    //    viewport={{ once: true }}
                    src={project.img}
                       className='shadow-xl hover:shadow-2xl sm:max-w-[400px] lg:max-w-[500px] max-h-[300px] md:max-h-[450px] my-2 sm:m-4'
                       />
                    </Link>
