...
export default function Home() {
  return (
    <div className='scroll-smooth bg-[rgb(241,241,241)] inset-0 text-black h-screen snap-y snap-mandatory overflow-y-scroll overflow-x-hidden z-0 scrollbar scrollbar-thin scrollbar-track-gray-400/5 scrollbar-thumb-[rgb(107,43,43)]/80 py-5 sm:p-5'>
      <Head>
